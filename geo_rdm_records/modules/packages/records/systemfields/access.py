...
"""Package access system field."""

from invenio_records.systemfields import SystemField


class PackageAccess:
    """Access management per package.

    This class is implemented based on ``CommunityAccess`` from ``invenio-communities``.
    """
    ...
    def from_dict(
        ...
        The new ``PackageAccess`` object will be populated with new instances
...
class PackageAccessField(SystemField):
    """System field for managing record access.

    This class is implemented based on ``CommunityAccessField`` from ``invenio-communities``.
    """

    access_obj_class = PackageAccess
