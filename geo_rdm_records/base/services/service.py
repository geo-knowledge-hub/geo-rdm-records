...
class BaseGEORecordService(BaseRDMRecordService):
    """Base record service."""
    ...
    def search(
        ...
        search = self._search(
            ...
            params,
            search_preference,
            extra_filter=dsl.Q("term", **{"parent.type": self.config.record_type}),
            **kwargs
        )
    ...
    def search_drafts(
        ...
        search_result = self._search(
            ...
            extra_filter=dsl.Q(
                "term", **{"has_draft": False, "parent.type": self.config.record_type}
            ),
    ...
    def search_versions(
        ...
        search_result = self._search(
            ...
            extra_filter=(
                dsl.Q("term", **{"parent.id": str(record.parent.pid.pid_value)})
                & dsl.Q("term", **{"parent.type": self.config.record_type})
            ),
